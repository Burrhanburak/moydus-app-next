...
export const metadata: Metadata = {
  ...
  description: "Professional web development services. Custom websites, e-commerce platforms, and SaaS applications built by a leading web development company. Full-stack development services for businesses worldwide across 150+ countries.",
  keywords: [
    "web development",
  ...
  alternates: {
    canonical: "https://www.moydus.com/web-development",
  },
  openGraph: {
    title: "Web Development – Professional Website Development Services | Moydus",
    description: "Professional web development company building custom websites for businesses worldwide.",
    url: "https://www.moydus.com/web-development",
    type: "website",
    locale: "en_US",
    siteName: "Moydus",
    images: [
      {
        url: "/web-development/opengraph-image",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: "Web Development – Professional Website Development Services | Moydus",
    description: "Professional web development company building custom websites for businesses worldwide.",
    images: ["/web-development/opengraph-image"],
  },
  robots: {
    index: true,
    follow: true,
...
export default function WebDevelopmentPage() {
  ...
  const pageSchema = buildWebPageSchema({
    ...
    title: "Web Development – Professional Website Development Services | Moydus",
    description:
      "Professional web development services. Custom websites, e-commerce platforms, and SaaS applications built by a leading web development company. Full-stack development services for businesses worldwide across 150+ countries.",
    datePublished,
    dateModified,
    image: {
      url: "https://www.moydus.com/web-development/opengraph-image",
      width: 1200,
      height: 630,
      alt: "Web Development – Professional Website Development Services",
    },
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="text-center pt-8 md:pt-12 mb-8 md:mb-12">
            ...
            <p className="text-white/70 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed mb-8">
              ...
              As a leading web development company and website development company, we provide full-stack development 
              services trusted by 10,000+ customers across 150+ countries.
            </p>
          ...
          <div
            id="main-content"
            data-narration-section
            data-title="What is Professional Web Development?"
            data-text="Professional web development involves building custom websites, web applications, and digital platforms using modern technologies and best practices. Unlike template-based solutions, professional web development companies deliver scalable, secure, and high-performing applications that drive business growth across all markets and regions worldwide."
          ...
          >
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-white/80 text-base md:text-lg leading-relaxed mb-6">
                Professional web development involves building custom websites, web applications, 
                and digital platforms using modern technologies and best practices. Unlike template-based 
                solutions, professional web development companies and website development companies 
                deliver scalable, secure, and high-performing applications that drive business growth 
                across all markets and regions worldwide.
              </p>
              <p className="text-white/80 text-base md:text-lg leading-relaxed mb-6">
                At Moydus, we combine technical expertise with business acumen to build web solutions 
                that not only function flawlessly but also scale with your business. As a leading 
                web development company and web development agency, our global team serves businesses 
                worldwide across 150+ countries, ensuring your web application performs optimally 
                regardless of geographic location or user base size.
              </p>
              ...
              <p className="text-white/80 text-base md:text-lg leading-relaxed mb-4">
                Investing in professional web development services offers numerous advantages over 
                DIY solutions or off-the-shelf platforms. Here&apos;s why businesses worldwide trust 
                professional web development companies, website development companies, and web development 
                agencies:
              </p>
              <ul className="text-white/80 text-base md:text-lg leading-relaxed mb-6 space-y-3 list-disc list-inside">
                <li>
                  ...
                  Every application is built to your exact specifications, ensuring it perfectly fits 
                  your business needs and workflows across different markets.
                </li>
                <li>
                  <strong className="text-white">Scalable Architecture:</strong>{" "}
                  Professional developers build applications that can grow with your business, handling 
                  increased traffic and users as you expand globally.
                </li>
                <li>
                  <strong className="text-white">Security & Compliance:</strong>{" "}
                  Your application will be built with security best practices and compliance standards, 
                  protecting your data and users worldwide.
                </li>
                <li>
                  <strong className="text-white">Performance Optimization:</strong>{" "}
                  Fast loading times, efficient code, and optimized databases ensure your application 
                  performs well for users around the globe.
                </li>
                <li>
                  <strong className="text-white">Ongoing Support:</strong>{" "}
                  Professional web development companies provide continuous maintenance, updates, and 
                  optimization to keep your application running smoothly internationally.
                </li>
              </ul>
              ...
              <p className="text-white/80 text-base md:text-lg leading-relaxed mb-6">
                A professionally developed web application is a powerful business tool that can 
                significantly impact your operations and revenue. Well-built applications improve efficiency, 
                reduce costs, and enable your business to serve customers more effectively. For businesses 
                operating globally, professional web development ensures your application maintains 
                consistent performance and reliability across all markets and regions.
              </p>
              <p className="text-white/80 text-base md:text-lg leading-relaxed mb-6">
                When users interact with your web application, they expect fast, reliable, and intuitive 
                experiences. A professional development approach ensures your application meets these 
                expectations, building trust and encouraging continued use. For international businesses, 
                this reliability is even more critical as it establishes credibility with users who may be 
                accessing your application from different time zones and locations.
              </p>
              <p className="text-white/80 text-base md:text-lg leading-relaxed mb-6">
                Beyond functionality, professional web development improves scalability and maintainability. 
                Clean code, proper architecture, and modern technologies make it easier to add features, 
                fix issues, and scale your application as your business grows. These factors directly contribute 
                to lower long-term costs and increased flexibility. Additionally, SEO-optimized development 
                helps your application rank higher in search results, making it easier for potential customers 
                worldwide to discover your services.
              </p>
            </div>
          </div>
