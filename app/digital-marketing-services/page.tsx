...
export const metadata: Metadata = {
  title: "Digital Marketing Services – SEO, Content & Performance Marketing | Moydus",
  description: "Comprehensive digital marketing services including SEO, local SEO, content marketing, and performance marketing. Drive growth and visibility for your business worldwide.",
  keywords: [
  ...
  openGraph: {
    title: "Digital Marketing Services – SEO, Content & Performance Marketing | Moydus",
    description: "Comprehensive digital marketing services to drive growth and visibility for your business.",
...
const services = [
  ...
  },
  {
    icon: MapPin,
    title: "Local SEO",
    description: "Target local customers and improve your presence in local search results.",
    href: "/services?category=local-seo",
  },
  {
    icon: Megaphone,
    title: "Content Marketing",
    description: "Strategic content creation and distribution to engage and convert your audience.",
  ...
  },
  {
    ...
    description: "Track performance and optimize campaigns with comprehensive analytics.",
      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="text-center pt-8 md:pt-12 mb-8 md:mb-12">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold mb-6 text-white">
            Digital Marketing Services
            <br />
            <span className="text-white/80">Drive Growth & Visibility Worldwide</span>
          </h1>
          <p className="text-white/70 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed mb-8">
            Comprehensive digital marketing services including SEO, content marketing, and performance marketing 
            to help your business grow and reach customers globally. Trusted by businesses across 150+ countries.
          </p>
            ...
            {services.map((service, index) => {
              ...
              return (
                <Link
                  key={index}
                  href={service.href}
                  className="bg-[#0a0a0a] border border-[#262626] rounded-2xl p-6 hover:border-white/20 transition-colors block"
                >
        ...
        <div className="mb-20 max-w-4xl mx-auto">
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <p className="text-white/80 text-base md:text-lg leading-relaxed mb-6">
              ...
              digital channels to reach and engage customers. This includes SEO,
              content marketing, social media, email marketing, and performance
              marketing. For businesses operating globally, digital marketing
              provides scalable strategies to reach customers across different
              markets and regions worldwide.
            </p>
            <p className="text-white/80 text-base md:text-lg leading-relaxed mb-6">
              At Moydus, we combine data-driven strategies with creative
              execution to help your business grow and reach customers globally.
              Our global team serves businesses worldwide across 150+ countries,
              ensuring your marketing campaigns perform optimally regardless of
              geographic location or target market.
            </p>
            ...
            <p className="text-white/80 text-base md:text-lg leading-relaxed mb-4">
              ...
              Here&apos;s why businesses worldwide trust professional agencies:
            </p>
            <ul className="text-white/80 text-base md:text-lg leading-relaxed mb-6 space-y-3 list-disc list-inside">
              ...
              <li>
                ...
                Data-driven campaigns optimize your marketing spend, delivering
                better results and higher returns on investment across all
                markets.
              </li>
              <li>
                <strong className="text-white">Targeted Reach:</strong>{" "}
                Professional marketers understand how to target specific
                audiences, ensuring your campaigns reach the right customers at
                the right time globally.
              </li>
              <li>
            ...
            <p className="text-white/80 text-base md:text-lg leading-relaxed mb-6">
              When customers search for products or services online, they expect
              to find relevant, trustworthy businesses. Professional SEO and
              content marketing ensure your business appears in search results,
              building credibility and encouraging engagement. For international
              businesses, this visibility is even more critical as it
              establishes your presence in markets where you may not have
              physical locations.
            </p>
            <p className="text-white/80 text-base md:text-lg leading-relaxed mb-6">
              Beyond visibility, professional digital marketing improves
              conversion rates and customer lifetime value. Targeted campaigns,
              optimized landing pages, and personalized messaging increase the
              likelihood that visitors become customers. These factors directly
              contribute to higher revenue and improved business performance.
              Additionally, SEO-optimized content helps your business rank higher
              in search results, making it easier for potential customers
        ...
        <div className="bg-[#0a0a0a] border border-[#262626] rounded-2xl p-8 md:p-12 text-center mb-10">
          ...
          <p className="text-white/60 text-lg mb-8 max-w-2xl mx-auto">
            Let our digital marketing experts help you reach more customers and drive growth. 
            Available for businesses worldwide with scalable strategies and clear results.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
