      ...
      <section className="min-h-screen bg-[#000000] text-white px-4 md:px-7 py-10 md:py-16 lg:py-20">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="w-full aspect-video rounded-2xl overflow-hidden bg-[#000000] mb-8 md:mb-12">
            <Image
              src={cdn("/ecommerce-website-development/hero.jpg", 1920, 90) || "/ecommerce-website-development/hero.jpg"}
              alt="E-Commerce Website Development – Online Store Development Services"
              width={1920}
              height={1080}
              ...
              onError={(e) => {
                ...
                if (!target.src.includes("/ecommerce-website-development/hero.jpg")) {
                  target.src = "/ecommerce-website-development/hero.jpg";
                }
              }}
            />
          </div>
