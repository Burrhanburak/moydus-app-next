    ...
    <>
      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="w-full aspect-video rounded-2xl overflow-hidden bg-[#000000] mb-8 md:mb-12">
          <Image
            src={cdn("/software-company/hero.jpg", 1920, 90) || "/software-company/hero.jpg"}
            alt="Software Company – Custom Software Development Services"
            width={1920}
            height={1080}
            ...
            onError={(e) => {
              ...
              if (!target.src.includes("/software-company/hero.jpg")) {
                target.src = "/software-company/hero.jpg";
              }
            }}
          />
        </div>
