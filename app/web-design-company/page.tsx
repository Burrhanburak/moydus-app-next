    ...
    <>
      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="w-full aspect-video rounded-2xl overflow-hidden bg-[#000000] mb-8 md:mb-12">
          <Image
            src={cdn("/web-design-company/hero.jpg", 1920, 90) || "/web-design-company/hero.jpg"}
            alt="Web Design Company – Custom Website Design & Development"
            width={1920}
            height={1080}
            ...
            onError={(e) => {
              ...
              if (!target.src.includes("/web-design-company/hero.jpg")) {
                target.src = "/web-design-company/hero.jpg";
              }
            }}
          />
        </div>
