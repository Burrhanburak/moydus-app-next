...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-9 w-max items-center justify-center rounded-md bg-transparent px-4 py-2 text-sm font-medium disabled:pointer-events-none "
);
...
function NavigationMenuLink({
  ...
  const hasNoHoverBg = className?.includes("hover:!bg-transparent");
  return (
