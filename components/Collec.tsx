...
export default function Collec() {
  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between px-10 lg:px-10 gap-4">
        <div className="flex flex-col gap-3">
          ...
          <p className="text-white/70 text-base md:text-lg max-w-2xl leading-relaxed">
            ...
            stores, SaaS platforms, and automation tools. Ready-to-use solutions
            built for global brands and scalable businesses worldwide.
          </p>
        </div>
        <Link
          href="/marketplace/templates"
          className="group hidden items-center justify-center gap-2 rounded-[47px] bg-white px-6 py-3 transition-all duration-300 ease-in-out lg:flex self-start lg:self-center"
        >
      ...
      <div className="relative h-full w-screen max-w-max-screen overflow-hidden !px-5 !pb-10 lg:!px-5">
        <div
          ref={sliderRef}
        ...
        >
          {collections.map((collection, idx) => (
            <div
              key={idx}
              className="group relative w-full min-w-[350px] flex-1 cursor-pointer"
            >
